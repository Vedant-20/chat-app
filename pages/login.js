  ...
  const resetPassword=async ()=>{
    try {
      toast.promise(async()=>{
        ...
        success:'Reset email sent to your registerd email id',
  ...
  return isLoading || (!isLoading && currentUser) ? (<Loader/>) : (
    ...
    <ToastMessage/>
      <div className='flex items-center flex-col '>
          ...
          <div className='flex items-center justify-center gap-2 w-full mt-10 mb-5 '>
          ...
          <form className='flex flex-col items-center gap-3 w-[500px] mt-5' onSubmit={handleSubmit}>
              <input type="email" placeholder='Email' className='w-full h-14 bg-c5 rounded-xl outline-none border-none px-5 text-c3' autoComplete='off' onChange={(e)=>setEmail(e.target.value)} />
