...
const Composebar = () => {
    const {inputText, setInputText,data,attachment,setAttachment,setAttachmentPreview, editMsg, setEditMsg}=useChatContext()
  ...
  return (
    <div className='flex items-center gap-2 grow'>
        <input type='text' className='grow w-full outline-0 px-2 py-2 text-white bg-transparent placeholder:text-c3 outline-none text-base' placeholder='Type a message...' value={inputText} onChange={handleTyping} onKeyUp={onKeyUp}/>
