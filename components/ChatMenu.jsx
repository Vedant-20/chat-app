    ...
    <ClickAwayListener onClickAway={handleClickAway}>
        <div className='w-[200px] absolute top-[70px] right-5 bg-c0 z-10 rounded-md overflow-hidden'>
            <ul className='flex flex-col py-2 '>
                {!IamBlocked && <li className='flex items-center py-3 px-5 hover:bg-black cursor-pointer ' onClick={(e)=>{e.stopPropagation();handleBlock(isUserBlocked ? "unblock" : "block")}}>{isUserBlocked ? "Unblock" : "Block User"}</li>}
